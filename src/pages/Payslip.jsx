    ...
    <div className="card shadow p-4">
      ...
      <table className="table table-bordered">
        <tbody>
          <tr>
            <td>Basic Salary</td>
            <td className="text-end">{payslip.basicSalary.toLocaleString()}</td>
          </tr>
          <tr>
            <td>Housing Allowance</td>
            <td className="text-end">{payslip.housingAllowance || 0}</td>
          </tr>
          <tr>
            <td>Transport Allowance</td>
            <td className="text-end">{payslip.transportAllowance || 0}</td>
          </tr>
          <tr className="fw-bold">
            <td>Gross Salary</td>
            <td className="text-end">{payslip.grossSalary.toLocaleString()}</td>
          </tr>
        </tbody>
      </table>
      ...
      <table className="table table-bordered">
        <tbody>
          <tr>
            <td>PAYE</td>
            <td className="text-end">{payslip.paye || 0}</td>
          </tr>
          <tr>
            <td>NSSF</td>
            <td className="text-end">{payslip.nssf || 0}</td>
          </tr>
          <tr>
            <td>NHIF</td>
            <td className="text-end">{payslip.nhif || 0}</td>
          </tr>
          <tr>
            <td>Loan Deduction</td>
            <td className="text-end">{payslip.loanDeduction || 0}</td>
          </tr>
          <tr className="fw-bold">
            <td>Total Deductions</td>
            <td className="text-end">{payslip.totalDeduction}</td>
          </tr>
        </tbody>
      </table>

      <h4 className="text-end text-success">
        Net Salary: {payslip.netSalary.toLocaleString()} TZS
      </h4>
